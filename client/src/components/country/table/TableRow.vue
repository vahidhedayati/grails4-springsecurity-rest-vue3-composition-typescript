    ...
    <td class="dropdown">
      ...
      <span v-else>
        <button v-on:click="editCountry(country)">Edit</button>
         <button v-on:click="actionDropDown({value:'display'},country.id)">Display</button>
         <button v-on:click="actionDropDown({value:'delete'},country.id)">Delete</button>
      </span>
    </td>
  </tr>
</template>
...
import {getCountries, patchCountry, deleteCountry} from '@/services/CountryService'
...
export default defineComponent({
   ...
   setup(props, context) {
    const state = reactive({
      ...
      updatedCountryAlternative:{ name:  undefined,
      updateUser: undefined,
      id:  undefined,
      code: undefined,
      lastUpdated: undefined,
      error: []} as CountryObject,
