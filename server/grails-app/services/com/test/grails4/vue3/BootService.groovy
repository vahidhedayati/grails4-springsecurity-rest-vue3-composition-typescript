...
class BootService {
    ...
    def bootup() {
        ...
        Calendar endCalendar = Calendar.instance
        bootStrapContent?.each { key, values ->
            ...
            bootStrapContent?.keySet()?.each { k ->
                ...
                calendar.set(Calendar.MONTH, k as int)
                endCalendar.set(Calendar.MONTH, k as int)
                calendar.set(Calendar.DAY_OF_MONTH, 1)
                endCalendar.set(Calendar.DAY_OF_MONTH, calendar.getActualMaximum(Calendar.DAY_OF_MONTH))
                String period = " ${dateFormat.format(calendar.time)} - ${dateFormat.format(endCalendar.time)} "
        ...
        VehicleContract vc1  = new VehicleContract(contractName:'aa', vehicle: v1,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        VehicleContract vc2  = new VehicleContract(contractName:'bb',vehicle: v2,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        VehicleContract vc3  = new VehicleContract(contractName:'cc',vehicle: v3,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        VehicleContract vc4  = new VehicleContract(contractName:'dd',vehicle: v4,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        VehicleContract vc5  = new VehicleContract(contractName:'ee', vehicle: v5,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        VehicleContract vc6  = new VehicleContract(contractName:'ff', vehicle: v6,fromDate: lastYear, toDate: new Date(), driver:driver1).save()

        new VehicleContract(contractName:'gg',vehicle: v7,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        new VehicleContract(contractName:'hh',vehicle: v8,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        new VehicleContract(contractName:'ii',vehicle: v9,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        new VehicleContract(contractName:'jj',vehicle: v10,fromDate: lastYear, toDate: new Date(), driver:driver1).save()
        new VehicleContract(contractName:'kk',vehicle: v12,fromDate: lastYear, toDate: new Date(), driver:driver1).save()


        new VehicleContract(contractName:'qq',vehicle: v1,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'rr',vehicle: v2,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'ss',vehicle: v3,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'tt',vehicle: v4,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'uu',vehicle: v5,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'vv',vehicle: v6,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'ww',vehicle: v7,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'xx',vehicle: v8,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'yy',vehicle: v9,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'zz',vehicle: v10,fromDate: lastYear, toDate: new Date(), driver:driver2).save()
        new VehicleContract(contractName:'aabb',vehicle: v12,fromDate: lastYear, toDate: new Date(), driver:driver2).save()

        VehicleHistory vh1 = new VehicleHistory(contract: vc1,returnDate: new Date(),checkedOutBy: driver1,checkedInBy: driver2).save();
        new VehicleHistory(contract: vc2,returnDate: daysBack(-2),checkedOutBy: driver1,checkedInBy: driver2).save();
        new VehicleHistory(contract: vc3,returnDate: daysBack(-3),checkedOutBy: driver1,checkedInBy: driver2).save();

        new VehicleHistory(contract: vc4,returnDate: daysBack(-4),checkedOutBy: driver2,checkedInBy: driver1).save();
        new VehicleHistory(contract: vc5,returnDate: daysBack(-5),checkedOutBy: driver2,checkedInBy: driver1).save();
        new VehicleHistory(contract: vc6,returnDate: daysBack(-6),checkedOutBy: driver2,checkedInBy: driver1).save();
    ...
    Date getYesterday() {
        ...
        prevYear.add(Calendar.DAY_OF_MONTH, -1);
        return prevYear.time;
    }
    Date daysBack(int num) {
        Calendar prevYear = Calendar.getInstance();
        prevYear.add(Calendar.DAY_OF_MONTH, num);
        return prevYear.time;
    }
    Date getLastYear() {
        Calendar prevYear = Calendar.getInstance();
